                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">Sagar Tech</span>
                        </Link>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'projects' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/admin/all-projects">{t('All Projects')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/admin/add-new-project">{t('Add New Project')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
